							...
							<div class="row mb-5">
								...
								<div class="col-sm-6" style="display:flex; padding-bottom: 20px;  padding-top: 20px" >
									 ...
									 <ul class="list-group list-group-flush" style="width: 63%; margin-left: 20px;">
										...
										<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
											<h6>도착지 : ${sa.s_pickUp}</h6>
										</li>
										<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
											<h6>${sa.d_name } 돌봄 받는 날: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp${sa.s_day }</h6>
										</li>
										<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
											<button class="btn btn-outline-primary" onclick = "location.href='PviewCare.do?S_num=${sa.s_num}'">상세보기</button>
										</li>
									</ul>
								</div>
								</c:forEach>
