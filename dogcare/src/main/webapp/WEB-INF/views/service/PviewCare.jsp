				...
				<div class="col-lg-8">
					<div class="card">
						<div class="card-body"><div class="row mb-3">
							...
							<div class="row mb-3">
								<div class="col-sm-3">
									<h6 class="mb-0" style="padding-top: 10px;">출발지</h6>
								</div>
								<div class="col-sm-9 text-secondary">
							...
							<div class="row mb-3">
								<div class="col-sm-3">
									<h6 class="mb-0" style="padding-top: 10px;">도착지</h6>
								</div>
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" value="${serviceApply.s_pickUp }" id="address2" readonly="readonly" style="background-color: white;">
								</div>
							</div>
							<div class="row mb-3">
